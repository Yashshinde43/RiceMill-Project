  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/no-permission" element={<NoPermission />} /> {/* New route for no permission */}
        <Route
          path="/permision"
          element={<ProtectedRoute element={<PermissionsManagement />} allowedRole="admin" />}
        />
        <Route path="*" element={<NoPermission />} /> {/* Handle undefined routes */}
        ...
        <Route path='/dhanricesocietiesrate' element={<Dhanricesocietiesrate />} />
