...
const Showbranjawak = () => {
  ...
  const fetchTransactions = async () => {
    try {
      ...
      const response = await axios.get(`${apiBaseUrl}/other-bran-jawak-data/`, {
        headers: {
          "api-key": apiKey,
      ...
      <div className="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            A list of all the Bran Jawak  transactions in the system.
          </p>
        </div>
                ...
                <table className="min-w-full text-left table-auto border-collapse border border-gray-300">
                  <thead>
                    <tr className="bg-indigo-600 text-white">
                      ...
                      <th className="px-4 py-3 font-semibold">Oil Percentage</th>
                    ...
                    {transactions.length === 0 ? (
                      ...
                      transactions.map((transaction) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-gray-800">{transaction.net_receivable}</td>
                          <td className="px-4 py-3 text-gray-800">{transaction.payment_received}</td>
                          <td className="px-4 py-3 text-gray-800">{transaction.oil}</td>
